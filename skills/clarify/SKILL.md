...
- Before presenting results, run the shared [self-review checklist](../quality.md) — applied to the quality of the clarification artifact. Surface issues in the chat only if found.
