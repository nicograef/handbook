...
Break the PRD into **tracer bullet** phases. Each phase is a thin vertical
...
- Do NOT include specific file names, function names, or implementation details
  that are likely to change as later phases are built
...
> Source PRD: <brief identifier or relative path to PRD file>
