...
A stack-convention guide: how this handbook's agent setup counters sycophancy — an LLM's
...
4. When writing a new review- or grading-style skill, add both guards to its Constraints:
   zero-findings-valid and hold-under-pushback (copy the pattern from
   [cleanup](../.claude/skills/cleanup/SKILL.md) step 4 and
