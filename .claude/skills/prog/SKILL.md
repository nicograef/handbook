...
7. Write the state above, the plan file path, worktree paths and open tasks to the scratchpad.
8. Tell the user `/compact` is safe to run. Give them a short prompt to paste afterwards. It names the scratchpad file, the plan and the next step.
