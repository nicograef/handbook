...
13. Render with `scripts/md-to-epub.sh` and `STRICT=1`. A finding is a bug in step 8: fix the chapter, re-render. Report the assumptions, every unverified claim, and every drift from `BRIEF.md` with its reason.
