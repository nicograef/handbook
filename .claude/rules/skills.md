...
- One directory per skill; `SKILL.md` is required. At most one level of reference files, each named for its content (`git.md`, `lane-brief.md`) and introduced with when to open it.
