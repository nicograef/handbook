---
description: "Conventions for editing or creating conceptual reference documents in the theory/ directory."
paths: "theory/**"
---
...
Theory files are conceptual reference material — like lectures or book chapters. They cover
architecture patterns, domain knowledge, and technology deep-dives. They are **not** personal
runbooks (that's what `guides/` is for).
